...
Before operation, transfer the file ‘**color_discern.py**’ saved in ‘[**5. OpenCV Computer Vision Course/5.1 Application Course/ Source Code**’]() to the Raspberry Pi.

For file transfer methods, please consult the documents located in the directory ["**2. Raspberry Pi 5 Basic Operation and Configuration \> 2.2 Remote Access and Remote File Transfer**".]()
...
Before operation, transfer the file ‘**face.py、haarcascade_frontalface_default.xml**’ saved in ‘**[5. OpenCV Computer Vision Course/ 5.1 Application Course/ Source Code]()**’ to the Raspberry Pi.
...
Before operation, transfer the file ‘**apriltag_discern.py**’ saved in ‘**[5. OpenCV Computer Vision Course/5.1 Application Course/ Source Code]()**’ to the Raspberry Pi.
...
①Access the Raspberry Pi system using VNC according to the instructions provided in ‘**[2. Raspberry Pi 5 Basic Operation and Configuration\2.2 Remote Access and Remote File Transfer]()**’.

②Setup OpenCV environment according to the tutorials provided in ‘**[5. OpenCV Computer Vision Course\5.2 Basic Course\ 5.2.2 Build OpenCV Environment]()**’.
...
(2) Click-on <img class="common_img" src="../_static/media/chapter_5\section_4\media\image2.png"  /> to transfer files.
...
**numpy**” to install Numpy. For more information about Numpy, please move to the folder “**[3.Basic Programming Course->3.2 Python Programming->3.2.13 Python Numpy Basic Operation]()**” .
...
Before operation, please move to “**[5. OpenCV Computer Vision Course->5.2 Basic Course->5.2.7 Image Processing---Color Space Conversion->Sample Code]()**”, and copy the sample routine “**color_conversion.py**” and picture “img1.jpg” into the shared folder 
...
(1) Open virtual machine and start the system. Click “<img class="common_img" src="../_static/media/chapter_5\section_11\media\image10.jpeg"  /> ”, and then “<img class="common_img" src="../_static/media/chapter_5\section_11\media\image12.png"  /> ” or press “**Ctrl+Alt+T**” to open command line terminal.
...
① Open virtual machine and start the system. Click “<img class="common_img" src="../_static/media/chapter_5/section_12/media/image3.jpeg"  /> ”, and then “<img class="common_img" src="../_static/media/chapter_5/section_12/media/image5.png"  /> ” or press “**Ctrl+Alt+T**” to open command line terminal.
...
The routine “**Scale.py**” can be found in “**[5. OpenCV Computer Vision Lesson->5.2 Basic Course->5.2.8 Image Processing---Geometric Transformation->Routine Code->Scale.py]()**” .
...
Before operation, please copy the routine code in “[5.OpenCV-\>5.2 Basic Course->5.2.8 Image Processing --- Geometric Transformation-\>Routine Code]()” to the shared folder. 
...
1\) Open virtual machine and start the system. Click “<img class="common_img" src="../_static/media/chapter_5/section_12/media/image18.jpeg" /> ”, and then “<img class="common_img" src="../_static/media/chapter_5/section_12/media/image20.png" /> ” or press “**Ctrl+Alt+T**” to open command line terminal.
...
The routine “**Translation.py**” can be found in “**[5. OpenCV Computer Vision Lesson->5.2 Basic Course->5.2.8 Image Processing---Geometric Transformation->Routine Code->TranslaTion]()**” .
...
Before operation, please copy the routine “**Revolve**” in “**[5.OpenCV->5.2 Basic Course->5.2.8 Image Processing --- Geometric Transformation-\>Routine Code]()” to the shared folder**.
...
* Open virtual machine and start the system. Click “<img class="common_img" src="../_static/media/chapter_5/section_12/media/image35.jpeg"  /> ”, and then “<img class="common_img" src="../_static/media/chapter_5/section_12/media/image37.png"  /> ” or press “**Ctrl+Alt+T**” to open command line terminal.
...
The routine “**Revolve.py**” can be found in “**[5. OpenCV Computer Vision Lesson->5.2 Basic Course->5.2.8 Image Processing---Geometric Transformation->Routine Code->Revolve]()**” .
...
Before operation, please copy the routine “**Perspective**” in “[5.OpenCV->5.2 Basic Course->5.2.8 Image Processing --- Geometric Transformation-\>Routine Code]()” to the shared folder.
...
① Open virtual machine and start the system. Click “<img class="common_img" src="../_static/media/chapter_5/section_12/media/image50.jpeg"  /> ”, and then “<img class="common_img" src="../_static/media/chapter_5/section_12/media/image52.png"  /> ” or press “**Ctrl+Alt+T**” to open command line terminal.
...
The routine “**Perspective.py**” can be found in “**[5. OpenCV Computer Vision Lesson->5.2 Basic Course->5.2.8 Image Processing---Geometric Transformation->Routine Code->Perspective]()**” .
...
Before operation, please copy the routine “**Remap**” in “[5.OpenCV->5.2 Basic Course->5.2.8 Image Processing --- Geometric Transformation-\>Routine Code]()” to the shared folder.
...
* Open virtual machine and start the system. Click “<img class="common_img" src="../_static/media/chapter_5/section_12/media/image64.jpeg"  /> ”, and then “<img class="common_img" src="../_static/media/chapter_5/section_12/media/image66.png"  /> ” or press “**Ctrl+Alt+T**” to open command line terminal.
...
The routine “**copy.py**” can be found in “**[5. OpenCV Computer Vision Lesson->5.2 Basic Course->5.2.8 Image Processing---Geometric Transformation-\>Routine Code-\>Remap]()**”.
...
* Open virtual machine and start the system. Click “<img class="common_img" src="../_static/media/chapter_5/section_12/media/image77.jpeg" /> ”, and then “<img class="common_img" src="../_static/media/chapter_5/section_12/media/image79.png" /> ” or press “**Ctrl+Alt+T**” to open command line terminal.
...
The routine “**copy_all.py**” can be found in “**[5. OpenCV Computer Vision Course->5.2 Basic Course->5.2.8 Image Processing---Geometric Transformation->Routine Code]()**” .
...
Before operation, please copy the routine “**Remap**” in “**[5. OpenCV Computer Vision Course->5.2 Basic Course->5.2.8 Image Processing --- Geometric Transformation->Routine Code]()**” to the shared folder.
...
① Open virtual machine and start the system. Click “<img class="common_img" src="../_static/media/chapter_5/section_12/media/image89.jpeg"  /> ”, and then “<img class="common_img" src="../_static/media/chapter_5/section_12/media/image91.png"  /> ” or press “**Ctrl+Alt+T**” to open command line terminal.
...
The routine “**x_rotation.py**” can be found in “**[5. OpenCV Computer Vision Course->5.2 Basic Course->5.2.8 Image Processing---Geometric Transformation->Routine Code]()**” .
...
① Open virtual machine and start the system. Click “<img class="common_img" src="../_static/media/chapter_5/section_12/media/image101.jpeg"  /> ”, and then “<img class="common_img" src="../_static/media/chapter_5/section_12/media/image103.png"  /> ” or press “**Ctrl+Alt+T**” to open command line terminal.
...
The routine “**y_rotation.py**” can be found in “**[5. OpenCV Computer Vision Course->5.2 Basic Course->5.2.8 Image Processing---Geometric Transformation->Routine Code]()**” .
...
* Open virtual machine and start the system. Click “<img class="common_img" src="../_static/media/chapter_5/section_12/media/image113.jpeg" /> ”, and then “<img class="common_img" src="../_static/media/chapter_5/section_12/media/image115.png" /> ” or press “**Ctrl+Alt+T**” to open command line terminal.
...
The routine “**xy_rotation.py**” can be found in “[5. OpenCV Computer Vision Course->5.2 Basic Course->5.2.8 Image Processing---Geometric Transformation-\>Routine Code]()” .
...
Before operation, please copy the routine “**Scale**” in “**[5. OpenCV Computer Vision Course->5.2 Basic Course->5.2.8 Image Processing--- Geometric Transformation->Routine Code]()**” to the shared folder.
...
* Open virtual machine and start the system. Click “<img class="common_img" src="../_static/media/chapter_5/section_12/media/image125.jpeg"  /> ”, and then “<img class="common_img" src="../_static/media/chapter_5/section_12/media/image127.png"  /> ” or press “**Ctrl+Alt+T**” to open command line terminal.
...
The routine “**half_size.py**” can be found in “**[5. OpenCV Computer Vision Course->5.2 Basic Course->5.2.8 Image Processing---Geometric Transformation->Routine Code]()**” .
...
(1) Open virtual machine and start the system. Click “<img class="common_img" src="../_static/media/chapter_5/section_13/media/image7.png"  />”, and then “<img class="common_img" src="../_static/media/chapter_5/section_13/media/image9.png"  /> ” or press “**Ctrl+Alt+T**” to open command line terminal.
...
The routine “**filtering.py**” can be found in “[5. OpenCV Computer Vision Course->5.2 Basic Course->5.2.9 Image Processing --- Smoothing-\>Routine Code]()” .
...
Since edge detection is susceptible to noise in the image, first step is to remove the noise in the image. For detailed operation, please refer to the file in “**[5. OpenCV Computer Vision Course->5.2 Basic Course->5.2.9 Image Processing---Smoothing]()**” .
...
Before operation, please copy the routine “**edge_detection.py**”and sample picture “**luna.jpg**” in “[5. OpenCV Computer Vision Course->5.2 Basic Course->5.2.8 Image Processing --- Edge Detection-\>Routine Code]()” to the shared folder.
...
The routine “**edge_detection.py**” can be found in “**[5. OpenCV Computer Vision Course->5.2 Basic Course->5.2.8 Image Processing---Edge Detection-\>Routine Code]()**” .
...
Before operation, please copy the routine “**example_org.jpg**” in “[5. OpenCV Computer Vision Course->5.2 Basic Course->5.2.8 Image Processing --- Geometric Transformation-\>Routine Code]()” to the shared folder.
...
(1) Open virtual machine and start the system. Click “<img class="common_img" src="../_static/media/chapter_5/section_15/media/image8.jpeg" /> ”, and then “<img class="common_img" src="../_static/media/chapter_5/section_15/media/image10.png"/> ”
...
The routine “**morphology_operations.py**” can be found in “[5. OpenCV Computer Vision Course->5.2 Basic Course->5.2.8 Image Processing---Morphological Processing-\>Routine Code]()” .
...
* **Before operation, please copy the routine “threshold_demo.py” and sample picture “test.jpg” in “[5. OpenCV Computer Vision Course->5.2 Basic Course->5.2.12 Image Processing --- Thresholding-\>Routine Code]()” to the shared folder.**
* **The input command should be case sensitive and the keywords can be complemented by “Tab” key.**

① Open virtual machine and start the system. Click “<img class="common_img" src="../_static/media/chapter_5/section_16/media/image2.png"  /> ”, and then “<img class="common_img" src="../_static/media/chapter_5/section_16/media/image4.png"  /> ” or press “**Ctrl+Alt+T**” to open command line terminal.
...
The routine “**threshold_demo.py**” can be found in “**[5. OpenCV Computer Vision Course->5.2 Basic Course->5.2.12 Image Processing --- Thresholding-\>Routine Code]()**” .
...
* **Before operation, please copy the routine “adaptiveThreshold_demo.py” and sample picture “test.jpg” in “[5. OpenCV Computer Vision Course->5.2 Basic Course->5.2.12 Image Processing --- Thresholding-\>Routine Code]()” to the shared folder.**
...
① Open virtual machine and start the system. Click “<img class="common_img" src="../_static/media/chapter_5/section_16/media/image12.png"  /> ”, and then “<img class="common_img" src="../_static/media/chapter_5/section_16/media/image14.png"  /> ” or press “**Ctrl+Alt+T**” to open command line terminal.
...
The routine “**adaptiveThreshold_demo.py**” can be found in “**[5. OpenCV Computer Vision Course->5.2 Basic Course->5.2.12 Image Processing---Thresholding-\>Routine Code]()**” .
...
* **Before operation, please copy the routine “Otsu_demo.py” and sample picture “test.jpg” in “[5. OpenCV Computer Vision Course->5.2 Basic Course->5.2.12 Image Processing --- Thresholding-\>Routine Code” to the shared folder.]()**
* **The input command should be case sensitive and the keywords can be complemented by “Tab” key.**

:::

① Open virtual machine and start the system. Click “<img class="common_img" src="../_static/media/chapter_5/section_16/media/image22.png" /> ”, and then “<img class="common_img" src="../_static/media/chapter_5/section_16/media/image24.png" /> ” or press “**Ctrl+Alt+T**” to open command line terminal.
...
<img class="common_img" src="../_static/media/chapter_5\section_16\media\image27.jpeg"/><img class="common_img" src="../_static/media/chapter_5\section_16\media\image28.png"/>
...
The routine “**Otsu_demo.py**” can be found in “**[5. OpenCV Computer Vision Course->5.2 Basic Course->5.2.12 Image Processing---Thresholding-\>Routine Code]()**” .
...
* **Before operation, please copy the routine “contours_demo.py” and sample picture “test.jpg” in “[5. OpenCV Computer Vision Course->5.2 Basic Course->5.2.13 Image Processing --- Contour Introduction and Feature-\>Routine Code]()” to the shared folder.**
* **The input command should be case sensitive and the keywords can be complemented by “Tab” key.**

① Open virtual machine and start the system. Click “<img class="common_img" src="../_static/media/chapter_5\section_17\media\image2.png"  /> ”, and then “<img class="common_img" src="../_static/media/chapter_5\section_17\media\image4.png"  /> ” or press “**Ctrl+Alt+T**” to open command line terminal.
...
The routine “**contours_demo.py**” can be found in “**[5. OpenCV Computer Vision Course->5.2 Basic Course->5.2.13 Image Processing --- Contour Introduction and Feature-\>Routine Code]()**” .
...
* **Before operation, please copy the routine “moments_demo.py” and sample picture “test.jpg” in “[5. OpenCV Computer Vision Course->5.2 Basic Course->5.2.13 Image Processing --- Contour Introduction and Feature-\>Routine Code]()” to the shared folder.**
...
① Open virtual machine and start the system. Click “<img class="common_img" src="../_static/media/chapter_5/section_17/media/image12.png"  /> ”, and then “<img class="common_img" src="../_static/media/chapter_5/section_17/media/image14.png"  /> ” or press “**Ctrl+Alt+T**” to open command line terminal.
...
The routine “**moments_demo.py**” can be found in “**[5. OpenCV Computer Vision Course->5.2 Basic Course->5.2.13 Image Processing --- Contour Introduction and Feature-\>Routine Code]()**” .
...
* **Before operation, please copy the routine “approx_demo.py” and sample picture “test.jpg” in “[5. OpenCV Computer Vision Course->5.2 Basic Course->5.2.13 Image Processing --- Contour Introduction and Feature-\>Routine Code]()” to the shared folder.**
* **The input command should be case sensitive and the keywords can be complemented by “Tab” key.**

:::

① Open virtual machine and start the system. Click “<img class="common_img" src="../_static/media/chapter_5/section_17/media/image23.png"  /> ”, and then “<img class="common_img" src="../_static/media/chapter_5/section_17/media/image25.png"  /> ” or press “**Ctrl+Alt+T**” to open command line terminal.
...
The routine “**approx_demo.py**” can be found in “**[5. OpenCV Computer Vision Course->5.2 Basic Course->5.2.13 Image Processing---Contour Introduction and Feature-\>Routine Code]()**” .
...
* **Before operation, please copy the routine “hull_demo.py” and sample picture “test.jpg” in “[5. OpenCV Computer Vision Course->5.2 Basic Course->5.2.13 Image Processing --- Contour Introduction and Feature-\>Routine Code]()” to the shared folder.**
* **The input command should be case sensitive and the keywords can be complemented by “Tab” key.**

:::

① Open virtual machine and start the system. Click “<img class="common_img" src="../_static/media/chapter_5\section_17\media\image32.png"  /> ”, and then “<img class="common_img" src="../_static/media/chapter_5\section_17\media\image34.png"  /> ” or press “**Ctrl+Alt+T**” to open command line terminal.
...
The routine “**hull_demo.py**” can be found in “**[5. OpenCV Computer Vision Course->5.2 Basic Course->5.2.13 Image Processing---Contour Introduction and Feature-\>Routine Code]()**”
...
* **Before operation, please copy the routine “rect_demo.py” and sample picture “test.jpg” in “[5. OpenCV Computer Vision Course->5.2 Basic Course->5.2.13 Image Processing --- Contour Introduction and Feature-\>Routine Code]()” to the shared folder.**
* **The input command should be case sensitive and the keywords can be complemented by “Tab” key.**

:::

① Open virtual machine and start the system. Click “<img class="common_img" src="../_static/media/chapter_5/section_17/media/image40.png"  /> ”, and then “<img class="common_img" src="../_static/media/chapter_5/section_17/media/image42.png"  /> ” or press “**Ctrl+Alt+T**” to open command line terminal.
...
The routine “**rect_demo.py**” can be found in “**[5. OpenCV Computer Vision Course->5.2 Basic Course->5.2.13 Image Processing---Contour Introduction and Feature-\>Routine Code]()**”
...
* **Before operation, please copy the routine “bf_demo.py” and sample picture “test.jpg” in “[5. OpenCV Computer Vision Course->5.2 Basic Course->5.2.14 Image Processing --- Feature Matching-\>Routine Code]()” to the shared folder.**
* **The input command should be case sensitive and the keywords can be complemented by “Tab” key.**

:::

① Open virtual machine and start the system. Click “<img class="common_img" src="../_static/media/chapter_5/section_18/media/image2.png"/> ”, and then“<img class="common_img" src="../_static/media/chapter_5\section_18\media\image4.png" /> ” or press “**Ctrl+Alt+T**” to open command line terminal.
...
The routine “**bf_demo.py**” can be found in “**[5. OpenCV Computer Vision Course->5.2 Basic Course->5.2.14 Image Processing --- Feature Matching-\>Routine Code]()**” .
...
* **Before operation, please copy the routine “flann_demo.py” and sample pictures “test.jpg” and “test1.jpg” in “[5. OpenCV Computer Vision Course->5.2 Basic Course->5.2.14 Image Processing --- Feature Matching-\>Routine Code]()” to the shared folder.**
* **The input command should be case sensitive and the keywords can be complemented by “Tab” key.**

:::

① Open virtual machine and start the system. Click “<img class="common_img" src="../_static/media/chapter_5\section_18\media\image17.png"  /> ”, and then “<img class="common_img" src="../_static/media/chapter_5\section_18\media\image19.png"  /> ” or press “**Ctrl+Alt+T**” to open command line terminal.
...
The routine “**flann_demo.py**” can be found in “**[5. OpenCV Computer Vision Course->5.2 Basic Course->5.2.14 Image Processing---Feature Matching-\>Routine Code]()**” .
...
* **Before operation, please copy the routine “corners_demo.py” and sample pictures “test.jpg” in “[5. OpenCV Computer Vision Course->5.2 Basic Course->5.2.15 Image Processing --- Corner Detection-\>Routine Code]()” to the shared folder.**
* **The input command should be case sensitive and the keywords can be complemented by “Tab” key.**

:::

(1) Open virtual machine and start the system. Click “<img class="common_img" src="../_static/media/chapter_5/section_19/media/image6.png"  /> ”, and then “<img class="common_img" src="../_static/media/chapter_5/section_19/media/image8.png"  /> ” or press “**Ctrl+Alt+T**” to open command line terminal.
...
The routine “**corners_demo.py**” can be found in “**[5. OpenCV Computer Vision Course->5.2 Basic Course->5.2.15 Image Processing --- Corner Detection-\>Routine Code]()**”
